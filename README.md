...
Доступна интеграция с LLM в т.ч. для выполнения команд через вызов инструментов.
Подробнее - [здесь](./irene_plugin_llm/README.md)

На данный момент интеграция LLM не включена в Docker-сборку и может быть не совместима с ней.
